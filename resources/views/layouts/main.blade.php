        ...
        <div class="container mx-auto flex px-4 flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex items-center flex-col md:flex-row ">
                 <li>
                    ...
                    <a class="hover:text-gray-300 font-bold"href="{{route('movies.index')}}">Movies</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a class="hover:text-gray-300 font-bold"href="{{route('tv.index')}}">TV Shows</a>
                </li>
                <li class="md:ml-6  mt-3 md:mt-0">
                    <a class="hover:text-gray-300 font-bold"href="{{route('actors.index')}}">Actors</a>
                </li>
            ...
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <img src="/img/avatar.jpg" class="w-8 rounded-full ml-2 h-8" alt="avatar">
