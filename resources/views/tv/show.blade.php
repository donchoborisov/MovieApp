...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex flex-none">
                <img src="{{'https://image.tmdb.org/t/p/w500/'.$tvshow['poster_path']}}" alt="" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24">
    ...
    <div class="movie cast border-b border-gray-800"><!----- tv cast ------>
  ...
  <div class="movie pictures border-b border-gray-800" x-data="{isOpen:false, image:''}"><!----- tv pictures ------>
        <div class="container mx-auto px-4 py-16">
